...
\textbf{CCA on PKCS1 v1.5 in HTTPS [Bleichenbacher 1998]}:
Web server tells if 16 MSBs of plaintext = `02' for a given ciphertext.\\
\textbf{Defense}: treating incorrectly formatted message blocks in a manner indistinguishable from correctly formatted blocks.
\newline
