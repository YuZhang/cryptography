...
\end{frame}
\begin{frame}\frametitle{Definitions of OWF/OWP}
...
\end{itemize}
\end{frame}
\begin{frame}\frametitle{Hard-Core Predicates (HCP)}
\begin{figure}
\begin{center}
\input{tikz/hcp}
\end{center}
...
\end{frame}
\begin{frame}\frametitle{Constructing PRG from OWP}
\begin{theorem}
$f$ is an OWP and $\mathsf{hc}$ is an HCP of $f$. Then $G(s) \overset{\text{def}}{=} (f(s), \mathsf{hc}(s))$ constitutes a PRG with expansion factor $\ell(n) = n+1$.
\end{theorem}
\begin{theorem}
...
\end{theorem}
\end{frame}
\begin{frame}\frametitle{Blum-Micali Generator}
\begin{figure}
\begin{center}
\input{tikz/ePRG}
\end{center}
...
\end{frame}
\begin{frame}\frametitle{Constructing PRF from PRG}
\begin{theorem}
...
\end{frame}
\begin{frame}\frametitle{Constructing PRP from PRF}
